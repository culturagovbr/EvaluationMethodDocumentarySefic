$(function(){
    ...
    $formContainer.find('.js-evaluation-submit-sefic').on('click', function(){
        var $button = $(this);
        var url = MapasCulturais.createUrl('registration', 'saveEvaluationAndChangeStatus', {'0': MapasCulturais.registration.id, 'status': 'evaluated'});
        var data = $form.serialize();
