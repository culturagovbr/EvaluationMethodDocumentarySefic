<div class="registration-fieldset">
    <?php if($entity->opportunity->isRegistrationOpen()): ?>
        ...
        <a class="btn btn-primary" ng-controller="RegistrationController" ng-click="sendRegistration()"><?php \MapasCulturais\i::_e("Enviar inscrição");?></a>
    <?php else: ?>
        <p class="registration-help">
            <strong>
                ...
                $date = strftime("%d de {%B} de %G às %H:%M", $entity->opportunity->registrationTo->getTimestamp());
